...
--
-- Host: localhost    Database: realestateowners
-- ------------------------------------------------------
...
CREATE TABLE `realestates` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_realestates_user_id` (`id_owner`),
  CONSTRAINT `fk_realestates_user_id` FOREIGN KEY (`id_owner`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-05-02 19:25:09
